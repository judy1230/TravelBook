...
router.get('/restaurants/:restaurant_id', toursController.getRestaurants)
router.get('/attractions/:attraction_id', toursController.getAttractions)
router.get('/dailyTour/:tour_id', toursController.getDailyTours)
router.get('/daysTour/:tour_id', toursController.getDaysTours)
router.get('/tours/:tour_id', toursController.getBlogs)
router.get('/restaurant/:restaurant_id', toursController.getRestaurant)
router.get('/attraction/:attraction_id', toursController.getAttraction)
router.get('/dailyTour/:tour_id', toursController.getDailyTour)
router.get('/daysTour/:tour_id', toursController.getDaysTour)
