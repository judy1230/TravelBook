...
router.get('/tours/restaurants/:restaurant_id', toursController.getRestaurants)
router.get('/tours/attractions/:attraction_id', toursController.getAttractions)
router.get('/tours/dailyTour/:tour_id', toursController.getDailyTours)
router.get('/tours/daysTour/:tour_id', toursController.getDaysTours)
router.get('/tours/tours/:tour_id', toursController.getBlogs)
